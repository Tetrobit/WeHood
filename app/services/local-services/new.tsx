  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={[styles.title, { flex: 1, textAlign: 'center' }]}>Новая услуга</Text>
        <View style={{ width: 36 }} />
      </View>
      ...
      >
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.4)', justifyContent: 'center', alignItems: 'center' }}>
          <View style={{ backgroundColor: theme === DARK_THEME ? '#222' : '#fff', borderRadius: 24, padding: 28, width: 340, shadowColor: '#000', shadowOpacity: 0.2, shadowRadius: 16, elevation: 10 }}>
            <MaterialCommunityIcons name="check-circle" size={48} color="#00D26A" style={{ alignSelf: 'center', marginBottom: 12 }} />
            <Text style={{ fontSize: 20, fontWeight: 'bold', color: theme === DARK_THEME ? '#fff' : '#222', marginBottom: 24, textAlign: 'center' }}>Услуга отправлена на модерацию</Text>
            ...
            <TouchableOpacity style={{ backgroundColor: '#00D26A', borderRadius: 14, padding: 16, alignItems: 'center', marginTop: 10 }} onPress={() => { setModalVisible(false); router.back(); }}>
