    ...
    <View style={styles.container}>
      ...
      >
        <View style={{ backgroundColor: theme === 'dark' ? '#222' : '#fff', borderRadius: 24, padding: 28, width: 340, shadowColor: '#000', shadowOpacity: 0.2, shadowRadius: 16, elevation: 10 }}>
          <Text style={{ fontSize: 20, fontWeight: 'bold', color: theme === 'dark' ? '#fff' : '#222', marginBottom: 24, textAlign: 'center' }}>Уведомления о событии</Text>
          <Text style={{ color: theme === 'dark' ? '#fff' : '#222', fontSize: 16, marginBottom: 18, textAlign: 'center' }}>Ваше событие отправлено на публикацию. Спасибо за активность!</Text>
